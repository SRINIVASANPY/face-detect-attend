...
face_cas = cv2.CascadeClassifier(
    'C:/Users/Srini/AppData/Local/Programs/Python/Python312/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
cap = cv2.VideoCapture(0)
recognizer = cv2.face.LBPHFaceRecognizer_create()
recognizer.read('C:/Users/Srini/Desktop/face/trainer/trainer.yml')
flag = 0
id = 0
filename = 'filename'
dict = {
